...
Page({
    ...
    switchRightTab: function (e) {
        ...
        //获取商品信息
        wx.request({
          url: app.globalData.requestUrl + '/category/getGroupProInfoByFirstId',
          data: postdata,
          header: {
            'content-type': ''
          },
    ...
    getProBySecondId: function (e) {
      ...
      wx.request({
        url: app.globalData.requestUrl + '/category/getGroupProInfoBySecondId',
        data: postdata,
        header: {
          'content-type': ''
        },
    ...
    loadMore : function(e){
      ...
      page ++
      if (cat2_id == 0){
        var url = app.globalData.requestUrl + '/category/getGroupProInfoByFirstId'
        var postData = {
          cat_id: cat1_id,
          page: page
        }
      }else{
        var url = app.globalData.requestUrl + '/category/getGroupProInfoBySecondId'
        var postData = {
          cat_id: cat1_id,
          cat2_id: cat2_id,
          page: page
