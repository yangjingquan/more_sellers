...
Page({
    ...
    onLoad: function (options) {
      ...
      //获取一级分类信息
      wx.request({
        url: app.globalData.requestUrl + '/category/getFirstCatInfoMulti',
        data: { },
        header: {
          'content-type': ''
        },
        success: function (res) {
          //获取初始二级分类信息
          wx.request({
            url: app.globalData.requestUrl + '/category/getSecondCarInfoByIdMulti',
          ...
          //获取商品信息
          wx.request({
            url: app.globalData.requestUrl + '/category/getProInfoByFirstIdMulti',
            data: { cat_id: res.data.result[0]['cat_id'] },
            header: {
              'content-type': ''
            },
    ...
    getProBySecondId: function (e) {
      ...
      wx.request({
        url: app.globalData.requestUrl + '/category/getProInfoBySecondIdMulti',
        data: postdata,
        header: {
          'content-type': ''
        },
    ...
    loadMore : function(e){
      ...
      page ++
      if (cat2_id == 0){
        var url = app.globalData.requestUrl + '/category/getProInfoByFirstIdMulti'
        var postData = {
          cat_id: cat1_id,
          page: page
        }
      }else{
        var url = app.globalData.requestUrl + '/category/getProInfoBySecondIdMulti'
        var postData = {
          cat_id: cat1_id,
          cat2_id: cat2_id,
          page: page
